...
async function madlib() {
    ...
    var speak2 = " which was very impressive considering you got " + answers[5] + " of sleep after going to bed " + answers[6] + " last night. Today may have been a bit stressful due to " + answers[7] + " that made you lose track of time, but you got through it! Overall, you were so " + answers[8] + " today, but tomorrow is a new day! When you go to sleep you want to feel " + answers[9];
    var speak3 = " and after taking time for yourself at " + answers[10] + " , you definitely deserve to feel that way! Thank you for using Gratition, and enjoy the rest of your day!";
    speakText(speak1);
    speakText(speak2);
    speakText(speak3);
